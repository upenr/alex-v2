...
//Upen: Notifications
var allNots = JSON.parse(localStorage.getItem("mynots"));
var totalNotifications =allNots.length;
localStorage.setItem("prevNotificationLength", allNots.length);
if (localStorage.getItem("prevNotificationLength") < totalNotifications){
myApp.addNotification({
    title: 'IBM TechU',
    message: allNots[0].notification,
    media: '<img width="44" height="44" style="border-radius:100%" src="img/power.png">',
    onClick: function() {
		console.log("Total Notifications:", totalNotifications);
		console.log("Previous Notifications:", localStorage.getItem("prevNotificationLength"));
        myApp.alert(allNots[0].notification, 'Notification');
        //window.location.href = "/nots.html";
        /* var notificationPageContent = '<div class="page" data-page="my-page">' +
							'<div class="page-content">' +
							  '<p>'+allNots[0].notification+'</p>' +
							'</div>' +
						  '</div>';
		mainView.router.loadContent(notificationPageContent); */
    },
    closeOnClick: true
}); 
} else{
	// No new notifications
}//Upen: end notification
